...
function listenTo(element,eventType,fn) {
	...
	if ((typeof element.id == "undefined" || element.id == "") && element != document.body && element != document.documentElement && element != window) { console.log("better not add a listener to elements witout id: ",element); return false; }
	if (typeof window.customEventListeners == "undefined") { window.customEventListeners = {} }
	if (typeof window.customEventListeners[eventType] == "undefined" ) { window.customEventListeners[eventType] = {}; }
	if (typeof window.customEventListeners[eventType][element.id] != "undefined") { 		/* console.log("cannot add another listener for "+eventType+" to ",element); */ return false; }
